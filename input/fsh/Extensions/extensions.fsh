...
* ^url    = "https://fhir.dha.go.ke/fhir/StructureDefinition/prescription-digital-signature"
* ^status = #active
...
* ^url    = "https://fhir.dha.go.ke/fhir/StructureDefinition/insurance-pre-authorization"
* ^status = #active
* ^context[0].type       = #element
* ^context[0].expression = "MedicationRequest"
...
* ^url    = "https://fhir.dha.go.ke/fhir/StructureDefinition/refill-authorization"
* ^status = #active
* ^context[0].type       = #element
* ^context[0].expression = "MedicationRequest"
...
* ^url    = "https://fhir.dha.go.ke/fhir/StructureDefinition/controlled-substance-schedule"
* ^status = #active
* ^context[0].type       = #element
* ^context[0].expression = "MedicationRequest"
* ^context[1].type       = #element
...
* ^url    = "https://fhir.dha.go.ke/fhir/StructureDefinition/dispense-notification"
* ^status = #active
* ^context[0].type       = #element

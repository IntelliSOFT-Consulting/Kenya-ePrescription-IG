...
* meta.profile[0] = "https://fhir.dha.go.ke/fhir/StructureDefinition/ke-medication-request"
...
* extension[0].url = "https://fhir.dha.go.ke/fhir/StructureDefinition/prescription-digital-signature"
...
* extension[1].url = "https://fhir.dha.go.ke/fhir/StructureDefinition/refill-authorization"
...
* extension[2].url = "https://fhir.dha.go.ke/fhir/StructureDefinition/controlled-substance-schedule"
* extension[2].extension[0].url = "isControlled"
* extension[2].extension[0].valueBoolean        = false

// -- Extension 3: InsurancePreAuthorization --
* extension[3].url = "https://fhir.dha.go.ke/fhir/StructureDefinition/insurance-pre-authorization"
...
* medicationCodeableConcept = https://fhir.dha.go.ke/terminology/CodeSystem/generic-products-cs#GE10002 "Metformin 500 mg Oral Tablet"
...
* dosageInstruction[0].route = https://fhir.dha.go.ke/terminology/CodeSystem/route-of-administration-cs#RT10025 "Oral"
...
* meta.profile[0] = "https://fhir.dha.go.ke/fhir/StructureDefinition/ke-medication-dispense"
...
* extension[0].url = "https://fhir.dha.go.ke/fhir/StructureDefinition/dispense-notification"
...
* medicationCodeableConcept.coding[0].system  = "https://fhir.dha.go.ke/terminology/CodeSystem/generic-products-cs"

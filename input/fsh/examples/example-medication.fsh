...
* code = https://nshr-uat.sha.go.ke/CodeSystem/generic-products-cs#GE10015 "Azithromycin 500 mg Oral Tablet"

* status = #active

* form = https://nshr-uat.sha.go.ke/CodeSystem/formulation-cs#DF10594 "Tablet, Film-Coated"

...
* code = https://fhir.dha.go.ke/fhir/CodeSystem/generic-products-cs#GE10015 "Azithromycin 500 mg Oral Tablet"

* status = #active

* form = https://fhir.dha.go.ke/fhir/CodeSystem/formulation-cs#DF10594 "Tablet, Film-Coated"

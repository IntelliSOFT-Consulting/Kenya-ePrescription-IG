...
// Profile: kenya-episode-of-care
// ============================================================================

Instance: example-episodeofcare-otieno-oncology
InstanceOf: KenyaEpisodeOfCare
Usage: #example
...
* meta.profile[0] = "https://prescription.intellisoftkenya.com/StructureDefinition/kenya-episode-of-care"
